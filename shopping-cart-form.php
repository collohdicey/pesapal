<form action="pesapal-iframe.php" method="post">
	<table>
		<tr>
			<td>Amount:</td>
			<td><input type="text" name="amount" value="5" />
			(in Kshs)
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="first_name" value="Collins" /></td>
		</tr>
		<tr>
			<td>Shopper's Last Name:</td>
			<td><input type="text" name="last_name" value="Njoka" /></td>
		</tr>
		<tr>
			<td>Shopper's Email Address:</td>
			<td><input type="text" name="email" value="info@njoka.net" /></td>
		</tr>
		<tr>
